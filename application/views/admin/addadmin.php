...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>เพิ่มผู้ดูแลเว็บไซต์  Administrator</title>
        <!-- Bootstrap -->
                            ...
                            <div class="block-content collapse in">
                                ...
                                <? } else { } ?>
                                    <? $arr = array('class' =>'form-horizontal' );
                                     echo form_open('admin/data_addadmin',$arr); ?>
                                      <fieldset>
                                        <div class="control-group">
                                          <label class="control-label" for="username_create">ตั้ง Username </label>
                                          <div class="controls">
                                            <input name="username_create" type="text" class="span6" id="username_create" required> *
                                          </div>
                                        </div>
                                        
                                        <div class="control-group">
                                          <label class="control-label" for="password_create">ตั้ง Password </label>
                                          <div class="controls">
                                            <input name="password_create" type="password" class="span6" id="password_create" required> * # รหัสผ่านจะถูกเข้ารหัส MD5
                                          </div>
                                        </div>
                                        
                                        <div class="control-group" align="right">
                                          <button type="submit" class="btn btn-primary">เพิ่มผู้ดูแลเว็บไซต์</button>
