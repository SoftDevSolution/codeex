<? 
    ...
    //foreach ($get_data_visitor_customer as $cus) {  }
?>
<!doctype html>
<html lang="en">
...
<head>
    ...
    <title>Config Customer Contact</title>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="section-block" id="basicform">
                            <h3 class="section-title">Edit New Customer Contact</h3>
                            <hr>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="visitor">
                        <div class="card">
                            <div class="card-body">
                        <?
                            foreach ($get_data_visitor_customer as $mach) {
                                
                            }
                        ?>
                                <form action="<? echo base_url(); ?>member/visitor_customer/edit_data_visitor_customer" method="POST">
                                    <div class="form-row">
                                    ...
                                    <a href="<? echo base_url(); ?>member/visitor_customer"><button type="button" class="btn btn-warning">Back</button></a>
                                    </center>
                                </form>
                            </div>
