                                ...
                                <form action="<? echo base_url(); ?>member/machine/data_edit_machine" method="POST">
                                    <div class="form-row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="invoice_id" value="<? echo $invent->invoice_id; ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control" name="machine_type_id" id="machine_type_id" required>
                                                ...
                                                <option value="<? echo $mtype->machine_type_id; ?>" <? if($invent->machine_type_id==$mtype->machine_type_id){ echo "selected"; } else { } ?>>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select class="form-control" name="model_id" id="model_id">
                                                ...
                                                <option value="<? echo $machine->model_id; ?>" <? if($invent->model_id==$machine->model_id){ echo "selected"; } else { } ?>>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="machine_serial_no" name="machine_serial_no" placeholder="Machine S/N"
                                                value="<? echo $invent->machine_serial_no; ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="brand_id" id="brand_id">
                                                ...
                                                <option value="<? echo $brand->brand_id; ?>" <? if($invent->brand_id==$brand->brand_id){ echo "selected"; } else { } ?>>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="machine_price" name="machine_price" placeholder="Machine Price" value="<? echo $invent->machine_price; ?>"
                                                onkeypress="return IsNumeric(event,'price');">
                                            <span id="price" style="color: Red; display: none">* Please enter number (0 - 9)</span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="machine_stock">Machine Stock</label>
                                            <input type="number" class="form-control" id="machine_stock" name="machine_stock" placeholder="Machine Stock" value="<? echo $invent->machine_stock; ?>"
                                                onkeypress="return IsNumeric(event,'stock');">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="machine_sup_inv_no" name="machine_sup_inv_no" placeholder="Supplier Inv. No."
                                                value="<? echo $invent->machine_sup_inv_no; ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="machine_sup_inv_date" name="machine_sup_inv_date" placeholder="Date"
                                                value="<? echo $invent->machine_sup_inv_date; ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="machine_warranty_start_date">Warranty from Supplier ( Date Start)</label>
                                            <input type="date" class="form-control" id="machine_warranty_start_date" name="machine_warranty_start_date"
                                                placeholder="Warranty from Supplier ( Date Start)" onchange="cal_warranty();" value="<? echo $invent->machine_warranty_start_date; ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="date" class="form-control" id="machine_warranty_stop_date" name="machine_warranty_stop_date" placeholder="Warranty from Supplier ( Date Stop)"
                                                onchange="cal_warranty();" value="<? echo $invent->machine_warranty_stop_date; ?>">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="machine_warranty_year">Warranty from Supplier ( Year )</label>
                                            <input type="number" max="4" class="form-control" id="machine_warranty_year" name="machine_warranty_year" placeholder="Year"
                                                value="<? echo $invent->machine_warranty_year; ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="machine_company_inv_no" name="machine_company_inv_no" placeholder="Supplier Inv. No."
                                                value="<? echo $invent->machine_company_inv_no; ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="date" class="form-control" id="machine_company_inv_date" name="machine_company_inv_date" placeholder="Date"
                                                value="<? echo $invent->machine_company_inv_date; ?>">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="machine_warranty_comp_start_date">Warranty from Factory ( Date Start )</label>
                                            <input type="date" class="form-control" id="machine_warranty_comp_start_date" name="machine_warranty_comp_start_date"
                                                placeholder="Warranty from Company ( Date Start)" onchange="cal_warranty_company();" value="<? echo $invent->machine_warranty_comp_start_date; ?>">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="machine_warranty_comp_stop_date">Warranty from Factory ( Date Stop )</label>
                                            <input type="date" class="form-control" id="machine_warranty_comp_stop_date" name="machine_warranty_comp_stop_date"
                                                placeholder="Warranty from Company ( Date Stop )" onchange="cal_warranty_company();" value="<? echo $invent->machine_warranty_comp_stop_date; ?>">
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" id="machine_warranty_comp_year" name="machine_warranty_comp_year" placeholder="Year"
                                                value="<? echo $invent->machine_warranty_comp_year; ?>" readonly>
                                        </div>
                                        <div class="form-group col-md-3">
                                    ...
                                    <center>
                                        <hr>
                                        <input type="hidden" name="invoice_id" value="<? $id_invoice = $invent->invoice_id;  if(empty($id_invoice) or $id_invoice==""){ echo " 0"; } else { echo
                                            $id_invoice; }?>">
