        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <? } else { ?>
                                    <table class="table table-striped" id="dataTable">
                                        ...
                                        <tbody>
                                        <? 
                                            foreach ($data_machine_model as $key => $mach) {
                                                
                                                ?>
                                                            <tr>
                                                            <th scope="row"><? echo $key+1; ?></th>
                                                            <td><? echo $mach->model_name; ?></td>
                                                            <td>
                                                            <a href="<? echo base_url(); ?>member/config_machine_model/edit_machine_model/<? echo $mach->model_id; ?>" class="text-dark"><i class="fas fa-edit"></i></a>
                                                            &nbsp;
                                                            <a href="<? echo base_url(); ?>member/config_machine_model/delete_machine_model/<? echo $mach->model_id; ?>" class="text-danger" onclick="return confirm('Comfirm Delete?');"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                            </tr>
                                                <? } ?>
                                        </tbody>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12"  id="machine_model">
                        <div class="card">
                            <div class="card-body">
