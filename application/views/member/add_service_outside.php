        ...
        <form action="<? echo base_url(); ?>member/service_outside/add_data_service_outside" method="POST" enctype="multipart/form-data">
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="svo_revision_no" name="svo_revision_no" placeholder="Revision No. (จำนวนที่ทำซ้ำ)">
                </div>
                <div class="form-group col-md-3">
                    <label for="svo_date">Date</label>
                    <input type="date" class="form-control" id="svo_date" name="svo_date" placeholder="Date">
                </div>
                <div class="form-group col-md-3">
                    <label for="svo_company_name">Company Name</label>
                    <input type="text" class="form-control" id="svo_company_name" name="svo_company_name" placeholder="Company Name">
                </div>
                <div class="form-group col-md-3">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="svo_technician_name" name="svo_technician_name" placeholder="Technician Name">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_emp_receive">คนรับงาน</label>
                    <input type="text" class="form-control" id="svo_emp_receive" name="svo_emp_receive" placeholder="คนรับงาน">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_emp_id_1">คนทำงาน 1</label>
                    <input type="text" class="form-control" id="svo_emp_id_1" name="svo_emp_id_1" placeholder="คนทำงาน 1">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_emp_id_2">คนทำงาน 2</label>
                    <input type="text" class="form-control" id="svo_emp_id_2" name="svo_emp_id_2" placeholder="คนทำงาน 1">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_emp_id_3">คนทำงาน 3</label>
                    <input type="text" class="form-control" id="svo_emp_id_3" name="svo_emp_id_3" placeholder="คนทำงาน 1">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_emp_id_4">คนทำงาน 4</label>
                    <input type="text" class="form-control" id="svo_emp_id_4" name="svo_emp_id_4" placeholder="คนทำงาน 1">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_emp_id_5">คนทำงาน 5</label>
                    <input type="text" class="form-control" id="svo_emp_id_5" name="svo_emp_id_5" placeholder="คนทำงาน 1">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="svo_license_plate_4" name="svo_license_plate_4" placeholder="ทะเบียนรถใช้งาน 4">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_license_plate_5">ทะเบียนรถใช้งาน 5</label>
                    <input type="text" class="form-control" id="svo_license_plate_5" name="svo_license_plate_5" placeholder="ทะเบียนรถใช้งาน 5">
                </div>
                <div class="form-group col-md-4">
                    <label for="svo_active_type">Activity Type</label>
                    <input type="text" class="form-control" id="svo_active_type" name="svo_active_type" placeholder="Activity Type">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" min="0" class="form-control" id="svo_detail" name="svo_detail" placeholder="รายละเอียด">
                </div>
