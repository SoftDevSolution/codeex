                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="section-block" id="basicform">
                            <h3 class="section-title">Inventory (
                                <? echo number_format($count_inventory,0); ?>) &nbsp;
                                <a href="<? echo base_url(); ?>member/machine/add_machine"><button class="btn btn-sm btn-success"><i class="fas fa-plus-circle"></i> Add Invoice</button></a>
                            </h3>
                        </div>
                        <div class="card">
                            <div class="card-body">
