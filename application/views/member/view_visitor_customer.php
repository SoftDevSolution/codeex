...
<head>
    ...
    <title>Customer Contact | <? echo $data->nameweb; ?></title>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="section-block" id="basicform">
                            <h3 class="section-title">Add New Customer Contact (<? echo number_format($count_visitor_customer,0); ?> Types)</h3>
                            <hr>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<? echo base_url(); ?>member/machine" class="breadcrumb-link">Machine</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Add New Customer Contact</li>
                        </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive-lg">
                                    <table class="table table-striped" id="dataTable">
                                        ...
                                        <tbody>
                                        <? 
                                            foreach ($data_visitor_customer as $key => $mach) {
                                                ...
                                                ?>
                                                            ...
                                                            <td>
                                                            <a href="<? echo base_url(); ?>member/visitor_customer/edit_visitor_customer/<? echo $mach->vs_id; ?>" class="text-dark"><i class="fas fa-edit"></i></a>
                                                            &nbsp;
                                                            <a href="<? echo base_url(); ?>member/visitor_customer/delete_data_visitor_customer/<? echo $mach->vs_id; ?>" class="text-danger" onclick="return confirm('Comfirm Delete?');"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                            </tr>
                                                <? } ?>
                                        </tbody>
