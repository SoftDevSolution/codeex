                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="section-block" id="basicform">
                            <h3 class="section-title">Edit Company Data</h3>
                            <hr>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<? echo base_url(); ?>member/company" class="breadcrumb-link">Company Data</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Edit Company Data</li>
                            </ol>
                        </div>
        ...
        <form action="<? echo base_url(); ?>member/company/edit_data_company" method="POST"  enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="company_capital_investment" name="company_capital_investment" placeholder="Capital Investment" value="<? echo $mach->company_capital_investment; ?>">
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="company_bussiness_group" name="company_bussiness_group" placeholder="Bussiness Group" value="<? echo $mach->company_bussiness_group; ?>">
                </div>
                <div class="form-group col-md-6">
                    <label for="product_type">Product Type</label>
                    <input type="text" class="form-control" id="product_type" name="product_type" placeholder="Product Type" value="<? echo $mach->company_product_type; ?>">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="company_indust" name="company_indust" placeholder="Industrial Estate" value="<? echo $mach->company_indust; ?>">
                </div>
                <div class="form-group col-md-6">
