                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="section-block" id="basicform">
                            <h3 class="section-title">Add Inventory to Requisition</h3>
                            <hr>
                        </div>
                    </div>
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-body">
        <h4 class="text-primary">Requisition Data &nbsp;&nbsp;<a href="<? echo base_url(); ?>member/requisition/edit_requisition/<? echo $rqs_id; ?>"><i class="far fa-edit"></i></a> </h4> <hr>
            <div class="form-row">
...
<div class="card">
    ...
    <h4 class="text-success"><i class="fas fa-plus-circle"></i> Add Inventory</h4> <hr>
        ...
        <? foreach ($query_inventory as $inven) { 
            ...
            <th scope="row"><button class="btn btn-sm btn-success" id="btn_invent_<? echo $inven->machine_id; ?>" onclick="return Add_inventory(<? echo $inven->machine_id; ?>,<? echo $rqs_id; ?>);"><i class="fas fa-plus-circle"></i> Add Inventory</button></th>
...
<div class="card">
    <div class="card-body">
    <h4 class="text-primary">Inventory List</h4> <hr>
        ...
        <? foreach ($query_invent_in_invoice as $key => $invoices) { 
            ...
            ?></td>
            <td>
            <button class="btn btn-sm btn-danger" onclick="return Remove_inventory(<? echo $invoices->id_inven_to_invoice; ?>);"><i class="fas fa-minus-circle"></i> Remove Inventory</button>
            </td>
            </tr>
        <? } ?>
        <? } ?>
